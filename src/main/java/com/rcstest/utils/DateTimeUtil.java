...
public class DateTimeUtil {
    /**
     * DateTimeUtil is for custom setting time format.
     *
    ...
    //Run main function to see different format of time.
    public static void main(String[] args) {
        ...
        System.out.println("+++" + DateTimeUtil.formatedTime("yyyyMMdd_HHmmssSSS") +"+++");
    }
}
