 ...
 */
public class SelectContactActivityExTest extends SelectContactActivity{

    Logger logger  =  Logger.getLogger(SelectContactActivityExTest.class);

    public SelectContactActivityExTest(AndroidDriver<WebElement> driver){
        super(driver);
    }
